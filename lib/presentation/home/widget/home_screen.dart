          ...
          Center(
            child: Column(
              children: [
                ...
                Text('원하시는 서비스를 선택해주세요!', style: TextStyle(fontWeight: FontWeight.w500, fontSize: 16, color: SeenearColor.grey50)),
                const SizedBox(
                  height: 40,
                ),
              ],
            ...
            return Expanded(
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  Color bgColor = isNotOpened ? SeenearColor.grey10 : SeenearColor.blue10;
                  Color fgColor = isNotOpened ? SeenearColor.grey30 : SeenearColor.blue100;
